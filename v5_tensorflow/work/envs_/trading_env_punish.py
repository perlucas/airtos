...
class TradingEnv(py_environment.PyEnvironment):
    ...
    def __init__(self, df, window_size, frame_bound):
        ...
        num_inputs = window_size * self.signal_features.shape[1] + 2
    ...
    def _get_observation(self):
        ...
        return np.append(signals, [earnings, self._shares])
    ...
    def _update_and_get_reward(self, action):
        ...
        coef = 100
        if action == ACTION_NOOP and prev_price - self.prices[self._current_tick] < 5:
            return -1000

        return (cur_funds - prev_funds) * coef
