...
class CustomCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        """
        has_trained_enough = self.__last_explained_variance > 0.98 and self.__last_explained_variance < 1 and self.__last_value_loss > 0 and self.__last_value_loss < 0.005 and self.num_timesteps > 200000
